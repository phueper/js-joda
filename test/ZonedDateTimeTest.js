...
describe('ZonedDateTime', () => {
    ...
    describe('of() factories', () => {
        ...
        it('of(year, month, dayOfMonth,hour, minute, second, nanoOfSecond, zone)', () => {
            const zdt = ZonedDateTime.of(2016, 9, 27, 10, 0, 0, 0, FIXED_ZONE_00);
            const expectedZdt = ZonedDateTime.ofStrict(LocalDateTime.of(2016, 9, 27, 10, 0), FIXED_ZONE_00, FIXED_ZONE_00);
            assertEquals(expectedZdt, zdt);
        });

        it('ofInstant(dateTime, offset, zone)', () => {
            const zdt = ZonedDateTime.ofInstant(LocalDateTime.of(2016, 9, 27, 10, 0), FIXED_ZONE_00, FIXED_ZONE_00);
            const expectedZdt = ZonedDateTime.ofStrict(LocalDateTime.of(2016, 9, 27, 10, 0), FIXED_ZONE_00, FIXED_ZONE_00);
            assertEquals(expectedZdt, zdt);
        });

        describe('ofLenient(localDateTime, offset, zone)', () => {
            it('should construct an invalid zoned data time instance', () => {
            ...
            it('should fail for not equal zone offsets', () => {
                expect(() => {
        ...
        describe('from(temporal not supporting INSTANT_SECONDS)', () => {
            class ZDTTemporal {
            ...
            it('should ignore DateTimeException', () => {
                const expectedZdt = ZonedDateTime.ofStrict(LocalDateTime.of(2016, 9, 27, 10, 0), FIXED_ZONE_00, FIXED_ZONE_00);
            ...
            it('should re-throw a not DateTimeException', () => {
    ...
    describe('getters', () => {
        ...
        describe('isSupported()', () => {
            it('should support a ChronoField', () => {
                expect(zdt.isSupported(ChronoField.DAY_OF_MONTH)).to.be.true;
            });

            it('should support date/ time based ChronoUnits', () => {
        ...
        describe('range()', () => {
            it('should return the value range of ChronoFields', () => {
            ...
            it('should return value range of custom fields', () => {
        ...
        it('should return year, month, monthValue, etc values', () => {
    ...
    describe('with()', () => {
        ...
        it('should adjust to instant seconds', () => {
        ...
        it('should adjust into a custom field adjuster', () => {
            ...
            const customField = {
                adjustInto: (thisZdt, newValue) => thisZdt.with(ChronoField.DAY_OF_MONTH, newValue),
            };
    ...
    describe('truncatedTo', () => {
        it('should truncate to time based value', () => {
            const zdt = ZonedDateTime.ofStrict(LocalDateTime.of(2016, 10, 30, 2, 30), FIXED_ZONE_02, EUROPE_BERLIN);
    ...
    describe('plus custom unit', () => {
        it('should add a custom value', () => {
            ...
            const quarterDayUnit = {
                addTo: (thisZdt, amountToAdd) => thisZdt.plusHours(6 * amountToAdd),
            };
    ...
    describe('until with a custom unit', () => {
        it('should calculate the difference in a custom unit', () => {
            ...
            const quarterDayUnit = {
                between: (start, end) => MathUtil.intDiv(start.until(end, ChronoUnit.HOURS), 6),
            };
