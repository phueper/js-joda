...
describe('org.threeten.bp.TestLocalDate', () => {
    ...
    describe('lengthOfMonth()', () => {
        it('test_lengthOfMonth_notLeapYear', () => {
        ...
        it('test_lengthOfMonth_leapYear', () => {
    ...
    describe('withDayOfMonth()', () => {
        ...
        it('test_withDayOfMonth_illegal', () => {
            expect(() => {
...
*/
    ...
    describe('plusYears()', () => {
        ...
        it('test_plusYears_long_invalidTooSmall_validInt', () => {
            expect(() => {
                LocalDate.of(Year.MIN_VALUE, 1, 1).plusYears(-1);
            }).to.throw(DateTimeException);
        });

        it('test_plusYears_long_invalidTooSmall_invalidInt', () => {
            expect(() => {
